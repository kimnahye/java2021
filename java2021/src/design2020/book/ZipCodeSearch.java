...
//		jcb_zdo2 = new JComboBox(vzdos);//West
	...
	//콤보박스는뿌려질뗴ZDO컬럼의 정보를 오라클 서버에 꺼내 오기 
	public String[] getZDOList() {
		String zdos[] = null;
		//오라클서버에 보낼 select문 작성하기
		//String자체는 원본이 바뀌지 않는 특성이 있다 
		//StringBuiler단일 스래드 안전하고
		//StringBuffer다중 스래드 안전하다 
...
//	    }
	...
	public static void main(String[] args) {
		JFrame.setDefaultLookAndFeelDecorated(true);//스킨 
